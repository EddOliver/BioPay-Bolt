...
export default function PaymentMethodScreen() {
  ...
  async function findUserFaceID(image) {
    ...
    myHeaders.append('X-API-Key', "0gtrvn34ew99gr38wrgEWRjgdsfsdfsdfSDFSDFwnri0");
    ...
    return new Promise(resolve => {
      fetch(`https://biopay-local-tunnel.loca.lt/findUserBase`, requestOptions)
  ...
  const submitTransaction = async (user) => {
    return new Promise(resolve => {
      ...
      fetch("https://algorand-execute-transaction-464956242067.us-west1.run.app", requestOptions)
        .then((response) => response.json())
        .then((result) => {
          console.log(result);
          resolve(result)
